...
use bezzabot::model::tracking::TrackingModel;

#[test]
fn deserialize_tracking_model() {
    let json = r#"{
    "trackingsDto": 1234,
    "detailedTrackingsWithMultiMailDto": "test"
}"#;

    let model: TrackingModel = serde_json::from_str(json).unwrap();
